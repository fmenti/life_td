...
.. * :ref:`Non-coronagraphic angular differential imaging </tutorials/StarCat4.ipynb>`  (:download:`download notebook </tutorials/zimpol_adi.ipynb>`)

The notebooks can also be viewed on `Github  <https://github.com/fmenti/life_td/three/main/data_generation/docs/source/tutorials>`_.
