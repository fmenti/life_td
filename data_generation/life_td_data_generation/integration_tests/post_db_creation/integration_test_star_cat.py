...
def teff_and_dist_cat_data(number,dist_colname,temp_colname):
    # loading the correct table
    table=io.ascii.read(Path().additional_data+'catalogs/LIFE-StarCat'+number+'.csv')
    # exctracting the correct columns
...
def test_teff_vs_dist():
    ...
    ltc3_data = teff_and_dist_cat_data('3', ltc3_dist_colname, ltc3_temp_colname)

    ltc4_dist_colname = 'dist_st_value'
    ltc4_temp_colname = 'teff_st_value'
    ltc4_data = teff_and_dist_cat_data('4', ltc4_dist_colname, ltc4_temp_colname)

    #function
    teff_vs_dist_plot(db_data['dist_st_value'],db_data['teff_st_value'])

    teff_vs_dist_plot(ltc3_data[ltc3_dist_colname], ltc3_data[ltc3_temp_colname])

    teff_vs_dist_plot(ltc4_data[ltc4_dist_colname], ltc4_data[ltc4_temp_colname])
