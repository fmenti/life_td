...
def test_create_sdb_helpertable():
    ...
    columns = ['main_id', 'id', 'sdbid', 'name', '_r', 'raj2000', 'dej2000', 'pmra', 'pmde', 'sdb_host_main_id',
               'sp_type', 'sp_bibcode', 'plx_value', 'plx_err', 'plx_bibcode', 'type_short', 'type_long',
               'star_comp_no', 'teff', 'e_teff', 'plx_arcsec', 'e_plx_arcsec', 'lstar', 'e_lstar', 'rstar', 'e_rstar',
               'logg', 'e_logg', 'mh', 'e_mh', 'a_v', 'e_a_v', 'lstar_1pc', 'e_lstar_1pc', 'disk_r_comp_no', 'temp',
               'e_temp', 'ldisk_lstar', 'e_ldisk_lstar', 'rdisk_bb', 'e_rdisk_bb', 'ldisk_1pc', 'e_ldisk_1pc', 'lam0',
               'e_lam0', 'beta', 'e_beta', 'dmin', 'e_dmin', 'q', 'e_q', 'model_comps', 'parameters', 'evidence',
               'chisq', 'dof', 'model_mtime', 'url', 'phot_url', 'mnest_url', 'model_url', 'type', 'disks_ref']
