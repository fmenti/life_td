...
def remove_system(main_id,dictionary):
    ...
    for table in tables:
        dictionary[table] = dictionary[table][np.where(dictionary[table]['main_id'] != main_id)]
    ...
    dictionary['objects'] = dictionary['objects'][np.where(dictionary['objects']['main_id'] != main_id)]
    return dictionary

def remove_object(main_id,dictionary):
    # get object type from main id
    object_type = dictionary['objects']['type'][np.where(dictionary['objects']['main_id']==main_id)]
