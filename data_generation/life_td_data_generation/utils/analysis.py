...
from provider.utils import fetch_main_id, IdentifierCreator
...
def starcat_versions_lost_stars():
    ...
    ltc3_g_stars_update = fetch_main_id(ltc3_g_stars, id_creator=IdentifierCreator(name='main_id', colname='sim_name'))
    ...
    lost_g_stars = ltc3_g_stars_update['main_id'][
        np.where(np.invert(np.isin(ltc3_g_stars_update['main_id'], ltc4['main_id'])))]
    return lost_g_stars
